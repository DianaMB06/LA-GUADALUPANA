...
?>
	...
	<button class="botom1" onclick="location.href='./proveedores.php';">Regresar</button>
	<button class="botom2" onclick="location.href='./productoProveedor.php';">Actualizar</button>
	<button class="botom" onclick="location.href='./historial.php';">Historial de pago</button>
				...
				<?php foreach($ventas as $venta){
					...
					<td>
						<form action="enviandolo.php" method="POST">
							<input type="hidden" name="pendiente" id="pendiente" value="<?php echo $venta->id ?>">
							<input type="hidden" name="nombre" id="nombre" value="<?php echo $venta->nombre ?>">
							<input type="hidden" name="deuda" id="deuda" value="<?php echo -$venta->pendiente ?>">
