		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
                    ...
                    <td class="editar"><a class="btn btn-warning" href="<?php echo "editarProveedor.php?id=" . $proveedor->id?>"><img class="imajinece" src="../../img/edita.png" alt=""></a></td>
					<td class="eliminar">
						<form action="delete.php" method="POST">
							<input type="hidden" name="id" value="<?php echo $proveedor->id?>">
							<input type="image" src="../../img/eliminar.png" alt="" class="imajinece">
						</form>
					</td>
				</tr>
				<?php } ?>
