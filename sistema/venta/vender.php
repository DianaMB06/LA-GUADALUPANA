			...
			if(isset($_GET["status"])){
				if($_GET["status"] === "1"){
					...
					<div class="alert azul">
							<strong class="dentro">Error:</strong> El producto que buscas no existe
						</div>
					<?php
				}else if($_GET["status"] === "5"){
					?>
					<div class="alert morado">
							<strong class="dentro">Error: </strong>El producto está agotado
						</div>
					<?php
				}else{
					?>
...
<!--buscador de los productos con un metodo get-->
	<form class="buscar" action=""  method="GET">
        ...
        <input class="cajas" type="text" name="buscador"  id="buscador">
    </form>
    <!--fin de buscador-->
				...
				<tr>
					...
					<td class="quitar">
						<a class="estatico" href="<?php echo "quitarDelCarrito.php?indice=" . $indice?>">
							<img class="imajinece" src="../../img/quitar.png" alt="">
						</a>
					</td>
				</tr>
				<?php } ?>
